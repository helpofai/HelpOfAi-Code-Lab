  ...
  "node_modules/prettier/plugins/postcss.js"(exports, module) {
    (function(f) {
      ...
      var w = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports), sn = (t, e) => {
        ...
        if (e && typeof e == "object" || typeof e == "function") for (let n of Sl(e)) !Tl.call(t, n) && n !== s && bt(t, n, { get: () => e[n], enumerable: !(r = El(e, n)) || r.enumerable });
        return t;
      };
      var Te = (t, e, s) => (s = t != null ? bl(kl(t)) : {}, nn(e || !t || !t.__esModule ? bt(s, "default", { value: t, enumerable: true }) : s, t)), Al = (t) => nn(bt({}, "__esModule", { value: true }), t);
      var Ci = w((lx, os) => {
      ...
      var jt = w((px, Ri) => {
        ...
        var Ni = Ci(), Pi = as(), st = class t extends Error {
          ...
          showSourceCode(e) {
            ...
            if (e) {
              let { bold: f, gray: h, red: c } = Ni.createColors(true);
...
`);
      ...
      var Kt = w((mx, ls) => {
        "use strict";
        ls.exports.isClean = /* @__PURE__ */ Symbol("isClean");
        ls.exports.my = /* @__PURE__ */ Symbol("my");
      });
      var ut = w((yx, Di) => {
        "use strict";
...
` ? (s = 1, r += 1) : s += 1;
      ...
      var fe = w((vx, ji) => {
        ...
        function zi(t) {
          if (t[$i] = false, t.proxyOf.nodes) for (let e of t.proxyOf.nodes) zi(e);
        }
        var z = class t extends Fc {
          ...
          normalize(e, s) {
            if (typeof e == "string") e = Vi(Gi(e).nodes);
              ...
              typeof e.value != "string" && (e.value = String(e.value)), e = [new Fi(e)];
        ...
        z.default = z;
        z.rebuild = (t) => {
          t.type === "atrule" ? Object.setPrototypeOf(t, fs.prototype) : t.type === "rule" ? Object.setPrototypeOf(t, ps.prototype) : t.type === "decl" ? Object.setPrototypeOf(t, Fi.prototype) : t.type === "comment" ? Object.setPrototypeOf(t, Ui.prototype) : t.type === "root" && Object.setPrototypeOf(t, Yi.prototype), t[Wi] = true, t.nodes && t.nodes.forEach((e) => {
            z.rebuild(e);
          });
        };
      });
      ...
      var Ue = w((kx, ro) => {
        "use strict";
        var { nanoid: Yc } = Ki(), { isAbsolute: ys, resolve: gs } = {}, { SourceMapConsumer: Vc, SourceMapGenerator: zc } = Qi(), { fileURLToPath: Ji, pathToFileURL: Qt } = {}, Zi = jt(), jc = hs(), ds = as(), ms = /* @__PURE__ */ Symbol("lineToIndexCache"), Hc = !!(Vc && zc), eo = !!(gs && ys);
        function to(t) {
          if (t[ms]) return t[ms];
          let e = t.css.split(`
`), s = new Array(e.length), r = 0;
        ...
        var Be = class {
          ...
          constructor(e, s = {}) {
            ...
            if (this.css = e.toString(), this.css[0] === "\uFEFF" || this.css[0] === "￾" ? (this.hasBOM = true, this.css = this.css.slice(1)) : this.hasBOM = false, this.document = this.css, s.document && (this.document = s.document.toString()), s.from && (!eo || /^\w+:\/\//.test(s.from) || ys(s.from) ? this.file = s.from : this.file = gs(s.from)), eo && Hc) {
...
`, "	"];
        ...
        ho.exports = function(e, s = {}) {
          ...
          function H(W) {
            ...
            switch (i = r.charCodeAt(p), i) {
              ...
              case 64: {
                Zt.lastIndex = p + 1, Zt.test(r), Zt.lastIndex === 0 ? a = r.length - 1 : a = Zt.lastIndex - 2, f = ["at-word", r.slice(p, a + 1), p, a], p = a;
                break;
              }
              case 92: {
              ...
              default: {
                i === 47 && r.charCodeAt(p + 1) === 42 ? (a = r.indexOf("*/", p + 2) + 1, a === 0 && (n || A ? a = r.length : O("comment")), f = ["comment", r.slice(p, a + 1), p, a], p = a) : (er.lastIndex = p + 1, er.test(r), er.lastIndex === 0 ? a = r.length - 1 : a = er.lastIndex - 2, f = ["word", r.slice(p, a + 1), p, a], m.push(f), p = a);
                break;
              }
            }
            return p++, f;
      ...
      var rr = w((Px, go) => {
        "use strict";
        var Xc = Xt(), Jc = Me(), Zc = ft(), ef = $e(), mo = Jt(), tf = tr(), yo = { empty: true, space: true };
        function rf(t) {
        ...
        var vs = class {
          ...
          raw(e, s, r, n) {
            ...
            for (let c = 0; c < u; c += 1) i = r[c], o = i[0], o === "space" && c === u - 1 && !n ? l = false : o === "comment" ? (h = r[c - 1] ? r[c - 1][0] : "empty", f = r[c + 1] ? r[c + 1][0] : "empty", !yo[h] && !yo[f] ? a.slice(-1) === "," ? l = false : a += i[1] : l = false) : a += i[1];
            if (!l) {
...
`));
      ...
      var As = w((Xx, Ko) => {
        ...
        function jo(t) {
          let e;
          return t.type === "document" ? e = ["Document", Ge, "DocumentExit"] : t.type === "root" ? e = ["Root", Ge, "RootExit"] : e = Ho(t), { eventIndex: 0, events: e, iterator: 0, node: t, visitorIndex: 0, visitors: [] };
        }
        function ks(t) {
        ...
        var Ts = {}, he = class t {
          ...
          constructor(e, s, r) {
            ...
            else if (s instanceof t || s instanceof zo) n = ks(s.root), s.map && (typeof r.map > "u" && (r.map = {}), r.map.inline || (r.map.inline = false), r.map.prev = s.map);
            else {
              let i = Mf;
            ...
            this.result = new zo(e, n, r), this.helpers = { ...Ts, postcss: Ts, result: this.result }, this.plugins = this.processor.plugins.map((i) => typeof i == "object" && i.prepare ? { ...i, ...i.prepare(this.result) } : i);
          }
          async() {
        ...
        ca.exports = function(e, s = {}) {
          ...
          function ne(A) {
            ...
            switch (i = r.charCodeAt(d), i) {
              ...
              case 64: {
                ar.lastIndex = d + 1, ar.test(r), ar.lastIndex === 0 ? o = r.length - 1 : o = ar.lastIndex - 2, g = ["at-word", r.slice(d, o + 1), d, o], d = o;
                break;
              }
              case 92: {
      ...
      var _a = w((xt) => {
        ...
        function Ds(t) {
          ...
          for (var u = 0; u < t.length; u++) {
            var a = t[u];
            n ? (i.value += a, (a === "{" || a === "(") && r++, (a === ")" || a === "}") && r--) : a.search(/\s/) !== -1 ? i.before += a : (a === "(" && (i.type = "media-feature-expression", r++), i.value = a, i.sourceIndex = e + u, n = true), n && r === 0 && (a === ")" || u === t.length - 1 || t[u + 1].search(/\s/) !== -1) && (["not", "only", "and"].indexOf(i.value) !== -1 && (i.type = "keyword"), i.type === "media-feature-expression" && (i.nodes = xa(i.value, i.sourceIndex)), s.push(Array.isArray(i.nodes) ? new Ls.default(i) : new wa.default(i)), i = o(), n = false);
          }
        ...
        function Sp(t) {
          ...
          if (n !== null) {
            ...
            e.unshift(new wa.default({ type: "url", value: t.substring(0, i).trim(), sourceIndex: n[1].length, before: n[1], after: /^(\s*)/.exec(t.substring(i))[1] })), s = i;
          }
          ...
          for (var e = [], s = t.css.valueOf(), r = void 0, n = void 0, i = void 0, o = void 0, u = void 0, a = void 0, l = void 0, f = void 0, h = void 0, c = void 0, g = void 0, b = s.length, d = -1, p = 1, m = 0, y = function(O, q) {
            ...
            switch (r = s.charCodeAt(m), r === _t && (d = m, p += 1), r) {
              ...
              case Vd:
                ...
                break;
              case em:
                Ar.lastIndex = m + 1, Ar.test(s), Ar.lastIndex === 0 ? n = s.length - 1 : n = Ar.lastIndex - 2, e.push(["at-word", s.slice(m, n + 1), p, m - d, p, n - d, m]), m = n;
                break;
              case Ws:
                for (n = m, l = true; s.charCodeAt(n + 1) === Ws; ) n += 1, l = !l;
                r = s.charCodeAt(n + 1), l && r !== iu && r !== Gs && r !== _t && r !== Vs && r !== zs && r !== Ys && (n += 1), e.push(["word", s.slice(m, n + 1), p, m - d, p, n - d, m]), m = n;
                break;
              default:
                r === iu && s.charCodeAt(m + 1) === cu ? (n = s.indexOf("*/", m + 2) + 1, n === 0 && y("comment", "*/"), a = s.slice(m, n + 1), o = a.split(`
`), u = o.length - 1, u > 0 ? (f = p + u, h = n - o[u].length) : (f = p, h = d), e.push(["comment", a, p, m - d, f, n - h, m]), d = h, p = f, m = n) : (Or.lastIndex = m + 1, Or.test(s), Or.lastIndex === 0 ? n = s.length - 1 : n = Or.lastIndex - 2, e.push(["word", s.slice(m, n + 1), p, m - d, p, n - d, m]), m = n);
                break;
            }
            m++;
          }
      ...
      var mu = w((Nr, du) => {
        ...
        var Bm = (function() {
          function t(e) {
            ...
            return this.root.append(s), this.current = s, this.lossy ? this.tokens = (0, hu.default)({ safe: e.safe, css: e.css.trim() }) : this.tokens = (0, hu.default)(e), this.loop();
          }
          ...
          for (; a < i; ) {
            switch (h = n.charCodeAt(a), h === 10 && (o = a, u += 1), h) {
              ...
              case 34:
                ...
                break;
              case 64:
                Gr.lastIndex = a + 1, Gr.test(n), Gr.lastIndex === 0 ? c = n.length - 1 : c = Gr.lastIndex - 2, r.push(["atword", n.slice(a, c + 1), u, a - o, u, c - o, a]), a = c;
                break;
              case 92:
...
`), d = b.length - 1, d > 0 ? (y = u + d, v = c - b[d].length) : (y = u, v = o), r.push(["comment", p, u, a - o, y, c - v, a]), o = v, u = y, a = c;
        ...
        nl.exports = class {
          ...
          parenOpen() {
            ...
            if (e && this.error("Expected closing parenthesis", r), n = this.current.last, n && n.type === "func" && n.unbalanced < 0 && (n.unbalanced = 0, this.current = n), this.current.unbalanced++, this.newNode(new rl({ value: r[1], source: { start: { line: r[2], column: r[3] }, end: { line: r[4], column: r[5] } }, sourceIndex: r[6] })), this.position++, this.current.type === "func" && this.current.unbalanced && this.current.value === "url" && this.currToken[0] !== "string" && this.currToken[0] !== ")" && !this.options.loose) {
              ...
              this.position !== this.tokens.length - 1 && (this.position++, this.newNode(new sl({ value: o, source: { start: u, end: { line: this.currToken[4], column: this.currToken[5] } }, sourceIndex: this.currToken[6] })));
            }
          }
          parenClose() {
            let e = this.currToken;
            this.newNode(new rl({ value: e[1], source: { start: { line: e[2], column: e[3] }, end: { line: e[4], column: e[5] } }, sourceIndex: e[6] })), this.position++, !(this.position >= this.tokens.length - 1 && !this.current.unbalanced) && (this.current.unbalanced--, this.current.unbalanced < 0 && this.error("Expected opening parenthesis", e), !this.current.unbalanced && this.cache.length && (this.current = this.cache.pop()));
          }
          space() {
            let e = this.currToken;
          ...
          splitWord() {
            ...
            i = Cy(s, "@"), o = Ry(Ny(Oy([[0], i]))), o.forEach((u, a) => {
              ...
              } else h = new (e && e[0] === "(" ? by : sl)({ value: f, source: { start: { line: this.currToken[2], column: this.currToken[3] + u }, end: { line: this.currToken[4], column: this.currToken[3] + (l - 1) } }, sourceIndex: this.currToken[6] + o[a] }), h.type === "word" ? (h.isHex = /^#(.+)/.test(f), h.isColor = /^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i.test(f)) : this.cache.push(this.current);
              this.newNode(h);
            }), this.position++;
          }
          string() {
      ...
      var Ky = {};
      sn(Ky, { languages: () => ki, options: () => Ai, parsers: () => en, printers: () => Hy });
      ...
      var je = "string", He = "array", St = "cursor", ie = "indent", Ae = "align", kt = "trim", oe = "group", ae = "fill", me = "if-break", Tt = "indent-if-break", Oe = "line-suffix", At = "line-suffix-boundary", X = "line", Ot = "label", Ce = "break-parent", Ct = /* @__PURE__ */ new Set([St, ie, Ae, kt, oe, ae, me, Tt, Oe, At, X, Ot, Ce]);
      function Il(t) {
...
Expected it to be ${r}.`;
      ...
      var C = { type: X }, M = { type: X, soft: true }, Ul = { type: X, hard: true }, T = [Ul, Ne];
      function cn(t) {
      ...
      var ce = $l;
      var fn = Object.freeze({ character: "'", codePoint: 39 }), pn = Object.freeze({ character: '"', codePoint: 34 }), Wl = Object.freeze({ preferred: fn, alternate: pn }), Gl = Object.freeze({ preferred: pn, alternate: fn });
      function Yl(t, e) {
      ...
      var Rt = /* @__PURE__ */ Symbol.for("PRETTIER_IS_FRONT_MATTER");
      function Hl(t) {
        return !!t?.[Rt];
      }
      var Re = Hl;
...
`);
        ...
        let r = /* @__PURE__ */ Object.create(null), n = E(0, t, Cn, "").replace(On, "").trimEnd(), i;
        for (; i = Cn.exec(t); ) {
          let o = E(0, i[2], oc, "");
...
` : "") + u + " */";
      ...
      var Mn = ["noformat", "noprettier"], Bn = ["format", "prettier"], Un = "format";
      function lc(t) {
...
`);
      ...
      function Gn(t) {
        let { shebang: e, text: s, pragmas: r, comments: n } = Jr(t), i = qn(s), o = Dn({ pragmas: { [Un]: "", ...r }, comments: n.trimStart() });
        return (e ? `${e}
` : "") + o + (i.startsWith(`
`) ? `
` : `
...
` : "") + Gn(s);
      ...
      function ts(t, e) {
        ...
        let r = t.grandparent;
        return !Zr(s) && !(r && Zr(r)) ? false : !!(t.findAncestor((i) => i.type === "css-decl")?.prop?.startsWith("$") || Zr(r) || r.type === "value-func");
      }
      function Ze(t) {
      ...
      function hc(t, e, s) {
        let { node: r } = t, n = t.parent, i = t.grandparent, o = jn(t), u = o && n.type === "value-value" && (o === "grid" || o.startsWith("grid-template")), a = t.findAncestor((p) => p.type === "css-atrule"), l = a && Je(a, e), f = r.groups.some((p) => Ze(p)), h = t.map(s, "groups"), c = [""], g = qe(t, "url"), b = false, d = false;
        ...
        return f && c.push([c.pop(), Ne]), d && c.unshift("", T), l ? D(L(c)) : Xn(t) ? D(Pe(c)) : D(L(Pe(c)));
      }
      function di(t) {
...
`) return e + 2;
      ...
      var _i = _c;
      function bc(t, e) {
        return e === false ? false : t.charAt(e) === "/" && t.charAt(e + 1) === "/" ? Lt(t, e) : e;
      }
      var bi = bc;
      function Ec(t, e) {
        let s = null, r = e;
        for (; r !== s; ) s = r, r = En(t, r), r = _i(t, r), r = qt(t, r);
        return r = bi(t, r), r = Yt(t, r), r !== false && Vt(t, r);
      }
      var zt = Ec;
      ...
      function Ei(t, e, s) {
        ...
        if (n && Jn(n) && (r.groups.length === 1 || r.groups.length > 0 && r.groups[0].type === "value-comma_group" && r.groups[0].groups.length > 0 && r.groups[0].groups[0].type === "value-word" && r.groups[0].groups[0].value.startsWith("data:"))) return [r.open ? s("open") : "", Y(",", i), r.close ? s("close") : ""];
        if (!r.open) {
          let g = is(t);
          ye(i);
        ...
        let o = t.map(({ node: g, isLast: b, index: d }) => {
          ...
          return m;
        }, "groups"), u = ci(r, n), a = hi(r, n), l = ts(t, e), f = a || l && !u, h = a || u, c = D([r.open ? s("open") : "", L([M, Y(C, o)]), M, r.close ? s("close") : ""], { shouldBreak: f });
        return h ? le(c) : c;
      }
      function is(t) {
      ...
      function Oc(t, e, s) {
        ...
        return t.each(() => {
          ...
          let { next: o } = t;
          o.type === "css-comment" && !Vt(e.originalText, P(o), { backwards: true }) && !Re(n) || o.type === "css-atrule" && o.name === "else" && n.type !== "css-comment" ? r.push(" ") : (r.push(e.__isHTMLStyleAttribute ? C : T), zt(e.originalText, R(n)) && !Re(n) && r.push(T));
        }, "nodes"), r;
      }
      var De = Oc;
      function Cc(t, e, s) {
        ...
        switch (r.type) {
          ...
          case "css-rule":
            return [s("selector"), r.important ? " !important" : "", r.nodes ? [r.selector?.type === "selector-unknown" && Le(r.selector.value) ? C : r.selector ? " " : "", "{", r.nodes.length > 0 ? L([T, De(t, e, s)]) : "", T, "}", ei(r) ? ";" : ""] : ";"];
          case "css-decl": {
            ...
            return l = ui(r) ? an(l) : l, !u && Le(o) && !t.call(() => is(t), "value", "group", "group") && (l = L([T, le(l)])), [E(0, r.raws.before, /[\s;]/gu, ""), n.type === "css-atrule" && n.variable || Qn(t) ? r.prop : Ie(r.prop), o.startsWith("//") ? " " : "", o, r.extend || a ? "" : " ", e.parser === "less" && r.extend && r.selector ? ["extend(", s("selector"), ")"] : "", l, r.raws.important ? r.raws.important.replace(/\s*!\s*important/iu, " !important") : r.important ? " !important" : "", r.raws.scssDefault ? r.raws.scssDefault.replace(/\s*!default/iu, " !default") : r.scssDefault ? " !default" : "", r.raws.scssGlobal ? r.raws.scssGlobal.replace(/\s*!global/iu, " !global") : r.scssGlobal ? " !global" : "", r.nodes ? [" {", L([M, De(t, e, s)]), M, "}"] : oi(r) && !n.raws.semicolon && e.originalText[R(r) - 1] !== ";" ? "" : e.__isHTMLStyleAttribute && t.isLast ? Nt(";") : ";"];
          }
          case "css-atrule": {
          ...
          case "selector-string":
            return V(r.value, e);
          case "selector-tag":
            return [r.namespace ? [r.namespace === true ? "" : r.namespace.trim(), "|"] : "", t.previous?.type === "selector-nesting" ? r.value : _e(Kn(t, r.value) ? r.value.toLowerCase() : r.value)];
          case "selector-id":
            return ["#", r.value];
          case "selector-class":
            return [".", _e(V(r.value, e))];
          case "selector-attribute":
            return ["[", r.namespace ? [r.namespace === true ? "" : r.namespace.trim(), "|"] : "", r.attribute.trim(), r.operator ?? "", r.value ? wi(V(r.value.trim(), e), e) : "", r.insensitive ? " i" : "", "]"];
      ...
      var Nc = { features: { experimental_frontMatterSupport: { massageAstNode: true, embed: true, print: true } }, print: Cc, embed: vn, insertPragma: zn, massageAstNode: gn, getVisitorKeys: bn }, Si = Nc;
      var ki = [{ name: "CSS", type: "markup", aceMode: "css", extensions: [".css", ".wxss"], tmScope: "source.css", codemirrorMode: "css", codemirrorMimeType: "text/css", parsers: ["css"], vscodeLanguageIds: ["css"], linguistLanguageId: 50 }, { name: "PostCSS", type: "markup", aceMode: "text", extensions: [".pcss", ".postcss"], tmScope: "source.postcss", group: "CSS", parsers: ["css"], vscodeLanguageIds: ["postcss"], linguistLanguageId: 262764437 }, { name: "Less", type: "markup", aceMode: "less", extensions: [".less"], tmScope: "source.css.less", aliases: ["less-css"], codemirrorMode: "css", codemirrorMimeType: "text/x-less", parsers: ["less"], vscodeLanguageIds: ["less"], linguistLanguageId: 198 }, { name: "SCSS", type: "markup", aceMode: "scss", extensions: [".scss"], tmScope: "source.css.scss", codemirrorMode: "css", codemirrorMimeType: "text/x-scss", parsers: ["scss"], vscodeLanguageIds: ["scss"], linguistLanguageId: 329 }];
      var Ti = { bracketSpacing: { category: "Common", type: "boolean", default: true, description: "Print spaces between brackets.", oppositeDescription: "Do not print spaces between brackets." }, objectWrap: { category: "Common", type: "choice", default: "preserve", description: "How to wrap object literals.", choices: [{ value: "preserve", description: "Keep as multi-line, if there is a newline between the opening brace and first property." }, { value: "collapse", description: "Fit to a single line when possible." }] }, singleQuote: { category: "Common", type: "boolean", default: false, description: "Use single quotes instead of double quotes." }, proseWrap: { category: "Common", type: "choice", default: "preserve", description: "How to wrap prose.", choices: [{ value: "always", description: "Wrap prose if it exceeds the print width." }, { value: "never", description: "Do not wrap prose." }, { value: "preserve", description: "Wrap prose as-is." }] }, bracketSameLine: { category: "Common", type: "boolean", default: false, description: "Put > of opening tags on the last line instead of on a new line." }, singleAttributePerLine: { category: "Common", type: "boolean", default: false, description: "Enforce single attribute per line in HTML, Vue and JSX." } };
      var Pc = { singleQuote: Ti.singleQuote }, Ai = Pc;
      var en = {};
      ...
      function By(t, e) {
        ...
        for (let a = 0; a < s.length; ++a) {
          let l = s[a];
          if (e.parser === "scss" && l.type === "number" && l.unit === ".." && l.value.endsWith(".") && (l.value = l.value.slice(0, -1), l.unit = "..."), l.type === "func" && l.value === "selector" && (l.group.groups = [se(Yr(t).text.slice(l.group.open.sourceIndex + 1, l.group.close.sourceIndex))]), l.type === "func" && l.value === "url") {
      ...
      function Vr(t) {
        return t.type === "paren_group" && !t.open && !t.close && t.groups.length === 1 || t.type === "comma_group" && t.groups.length === 1 ? Vr(t.groups[0]) : t.type === "paren_group" || t.type === "comma_group" ? { ...t, groups: t.groups.map(Vr) } : t;
      }
      function pl(t, e) {
      ...
      function Uy(t, e) {
        ...
        let s = null;
        try {
          s = new fl.default(t, { loose: true }).parse();
        } catch {
      ...
      function Js(t, e, s) {
        ...
        try {
          ...
          throw typeof l != "number" ? o : ya(`${u}: ${a}`, { loc: { start: { line: l, column: f } }, cause: o });
        }
        return s.originalText = e, i = wl(te(i, "css-"), s), Xr(i, e), r && (i.frontMatter = { ...r, type: "front-matter", source: { startOffset: r.start.index, endOffset: r.end.index } }), i;
      }
      function vl(t, e = {}) {
      ...
      var Zs = { astFormat: "postcss", hasPragma: Yn, hasIgnorePragma: Vn, locStart: P, locEnd: R }, Vy = { ...Zs, parse: vl }, zy = { ...Zs, parse: xl }, jy = { ...Zs, parse: _l };
      var Hy = { postcss: Si };
      return Al(Ky);
    });
  }
