                                                ...
                                                <motion.tr key={user.id} layout className="group hover:bg-[var(--bg-elevated)] transition-colors">
                                                    <td className="px-8 py-6">
                                                        <div className="flex flex-col">
                                                            <span className={`text-sm font-black uppercase tracking-tight transition-colors ${user.is_blocked ? 'text-rose-500 line-through opacity-50' : 'text-[var(--text-main)] group-hover:text-cyan-500'}`}>{user.name}</span>
