        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-4 relative z-10">
                    ...
                    <div>
                        <h2 className="text-lg font-black text-[var(--text-main)] uppercase italic leading-none">Vendors Command</h2>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className={`bg-purple-500/5 border border-purple-500/20 rounded-2xl p-6 text-center space-y-4 shadow-xl mt-8`}>
                                ...
                                <h4 className="text-lg font-black uppercase tracking-widest text-[var(--text-main)] italic">Vendors Status</h4>
                                ...
                                {connections.some(c => c.is_valid) ? (
                                    <>
                                        ...
                                        <p className="text-xs text-[var(--text-muted)] font-medium leading-relaxed mt-4">
                                            Your vendors account is currently active and your integrations are healthy.
                                        </p>
                                    </>
                                ) : (
                                    <>
