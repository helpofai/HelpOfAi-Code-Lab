    ...
    const handleUpgrade = async () => {
        ...
        if (auth.user.role === 'paid-user' || auth.user.role === 'admin') {
            try {
                ...
                alert('Failed to communicate with billing node.');
            }
        } else {
